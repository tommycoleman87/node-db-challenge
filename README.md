...
A relational database is a digital database buit around the relational model, sql is the language we use to query the database.
- [ ] Why do tables need a `primary key`?
So that you can have access to each row level.
